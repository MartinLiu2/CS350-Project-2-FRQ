...
80103f72:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f79:	e8 02 2d 00 00       	call   80106c80 <freevm>
        release(&ptable.lock);
...
801040cb:	68 1f 79 10 80       	push   $0x8010791f
...
8010563d:	e8 de e7 ff ff       	call   80103e20 <sleep>
  while(ticks - ticks0 < n){
...
801056e5:	e8 e6 e8 ff ff       	call   80103fd0 <wakeup>
  return 0;
}
...
80105708:	e8 f3 e4 ff ff       	call   80103c00 <sleep1>
  return 0;
}
...
801059fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105a00:	e8 9b e2 ff ff       	call   80103ca0 <exit>
...
80105a24:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105a2b:	e8 a0 e5 ff ff       	call   80103fd0 <wakeup>
      release(&tickslock);
